        ...
        <div class="flex items-center justify-between">
            <a href="/antifraud-kz/" class="flex items-center space-x-3">
                <div class="w-10 h-10 md:w-12 md:h-12 bg-primary rounded-full flex items-center justify-center flex-shrink-0">
                    <svg class="w-6 h-6 md:w-7 md:h-7 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm-2 16l-4-4 1.41-1.41L10 14.17l6.59-6.59L18 9l-8 8z"/></svg>
                </div>
                <div><h1 class="font-heading text-lg md:text-xl font-bold">АНТИФРОД</h1><p class="text-xs text-gray-400 hidden sm:block">Центр Казахстан</p></div>
            </a>
            <nav class="hidden lg:flex items-center space-x-5">
                <a href="/antifraud-kz/" class="hover:text-primary transition nav-link text-sm" data-page="home">Главная</a>
                <a href="/antifraud-kz/check.html" class="hover:text-primary transition nav-link text-sm" data-page="check">Проверка</a>
                <a href="/antifraud-kz/quiz.html" class="hover:text-primary transition nav-link text-sm" data-page="quiz">Заявка</a>
                <a href="/antifraud-kz/services.html" class="hover:text-primary transition nav-link text-sm" data-page="services">Услуги</a>
                <a href="/antifraud-kz/team.html" class="hover:text-primary transition nav-link text-sm" data-page="team">Команда</a>
                <a href="/antifraud-kz/cases.html" class="hover:text-primary transition nav-link text-sm" data-page="cases">Кейсы</a>
                <a href="/antifraud-kz/contacts.html" class="hover:text-primary transition nav-link text-sm" data-page="contacts">Контакты</a>
            </nav>
            <div class="flex items-center space-x-3">
                <a href="/antifraud-kz/quiz.html" class="hidden sm:inline-flex items-center gap-2 bg-primary hover:bg-primary/80 px-4 py-2 rounded-lg font-heading text-sm transition">
                    <span class="hidden md:inline">ОСТАВИТЬ ЗАЯВКУ</span>
                    <span class="md:hidden">ЗАЯВКА</span>
                </a>
                <button id="mobileMenuBtn" class="lg:hidden text-white p-1">
                    <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/></svg>
                </button>
            </div>
        </div>
    </div>
    <div id="mobileMenu" class="hidden lg:hidden bg-dark border-t border-gray-800">
        <nav class="container mx-auto px-4 py-4 flex flex-col space-y-1">
            ...
            <a href="/antifraud-kz/team.html" class="py-3 px-3 hover:bg-white/5 rounded-lg transition nav-link" data-page="team">Команда</a>
            <a href="/antifraud-kz/cases.html" class="py-3 px-3 hover:bg-white/5 rounded-lg transition nav-link" data-page="cases">Кейсы</a>
            <a href="/antifraud-kz/contacts.html" class="py-3 px-3 hover:bg-white/5 rounded-lg transition nav-link" data-page="contacts">Контакты</a>
            <a href="/antifraud-kz/quiz.html" class="mt-2 bg-primary py-3 text-center rounded-lg font-heading text-sm">ОСТАВИТЬ ЗАЯВКУ</a>
        </nav>
    </div>
</header>`;
...
<div id="warningBanner" class="fixed top-16 left-0 right-0 z-40 bg-gradient-to-r from-primary to-red-700 py-3 px-4 text-center text-white text-sm font-bold cursor-pointer hidden" onclick="window.location.href='/antifraud-kz/quiz.html'">
    ...
    var footerHTML = `
<footer class="py-12 bg-darker border-t border-gray-800 pb-24 lg:pb-12">
...
<a href="https://wa.me/77001234567?text=%D0%97%D0%B4%D1%80%D0%B0%D0%B2%D1%81%D1%82%D0%B2%D1%83%D0%B9%D1%82%D0%B5%2C%20%D1%85%D0%BE%D1%87%D1%83%20%D0%BE%D1%81%D1%82%D0%B0%D0%B2%D0%B8%D1%82%D1%8C%20%D0%B7%D0%B0%D1%8F%D0%B2%D0%BA%D1%83" target="_blank" class="fixed bottom-20 lg:bottom-6 right-4 z-50 bg-green-500 hover:bg-green-600 w-14 h-14 rounded-full flex items-center justify-center shadow-lg transition transform hover:scale-110" id="waBtn">
...
<nav class="fixed bottom-0 left-0 right-0 lg:hidden bg-dark/95 backdrop-blur-sm border-t border-gray-800 z-50">
    <div class="flex justify-around py-2">
        <a href="/antifraud-kz/" class="flex flex-col items-center py-1 px-2 text-xs"><svg class="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>Главная</a>
        <a href="/antifraud-kz/check.html" class="flex flex-col items-center py-1 px-2 text-xs"><svg class="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>Проверка</a>
        <a href="/antifraud-kz/quiz.html" class="flex flex-col items-center py-1 px-2 text-xs bg-primary rounded-lg -mt-2 px-3"><svg class="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>Заявка</a>
        <a href="/antifraud-kz/services.html" class="flex flex-col items-center py-1 px-2 text-xs"><svg class="w-5 h-5 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>Услуги</a>
        <a href="tel:1434" class="flex flex-col items-center py-1 px-2 text-xs"><svg class="w-5 h-5 mb-1 text-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>Звонок</a>
    </div>
</nav>`;
